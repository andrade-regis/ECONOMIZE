...
![Tela Apresentação](capturas_tela/introdução.png)

![Tela de Saldo Inicial (Para calcular com valores dos meses anteriores)](capturas_tela/tela_saldo.png)

![Tela Principal](capturas_tela/tela_principal.png)

![Tela Transações](capturas_tela/tela_transação.png)

![Tela Principal Com Valores](capturas_tela/tela_principal_dados.png)
